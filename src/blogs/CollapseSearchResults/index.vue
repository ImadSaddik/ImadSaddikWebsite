<template>
  <section class="article-container">
    ...
    <div class="article-body">
      ...
      <p>
        Without collapsing, the search results will return all documents that match the query. In this case, the number
        is 270 documents.
      </p>
      <CodeOutput :code-output="codeOutput1" />

      <p>
        Let's look at the count of documents that matched the query per year in the <InlineCode text="apod index" />.
      </p>

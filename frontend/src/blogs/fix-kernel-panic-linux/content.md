...
subtitle: "A step-by-step guide to recovering your Linux system from a broken kernel update using GRUB."
...
::: warning
Double-check that this is **NOT** the version you are currently using (from the `uname -r` command).
:::
